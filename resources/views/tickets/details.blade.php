...
<div class="container">
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            @endif
            <p class="date-t">
            	<span class="glyphicon glyphicon-item"></span>{{ $ticket->created_at->format('d/y/y h:ia')}}
            	-{{ $ticket->author->name}}
            </p>
            ...
            <h3>Nuevo Comentario</h3>
             ...
             {!! Form::open(['route' => ['comments.submit', $ticket->id], 'method' => 'POST'])!!}
                ...
                {!! Form::textarea('comment', null,['class' => 'form-control', 'placeholder' => 'Escribe tu comentario'])!!}
                    
                </div>
                <div class="form-group">
                {!! Form::label('link', 'Link')!!}
                {!! Form::text('link', null,['class' => 'form-control', 'placeholder' => 'Escribe un link valido'])!!}
